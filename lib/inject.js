...
const PromptButtonsPanel = ({ buttons, onButtonClick, isAuthorized, }) => {
    ...
    ${buttons
        ...
        .join("")}
    <a href="${urls/* urls.external.CHATTERBOX */.j.external.CHATTERBOX}" class="cb-hint cb-promo-hint" target="_blank" rel="noopener noreferrer">by chatterbox.one</a>`;
    const notAuthContent = `<a href="${urls/* urls.external.ACCOUNT_MY */.j.external.ACCOUNT_MY}" class="cb-hint" target="_blank" rel="noopener noreferrer">Войти в chatterbox.one</a>`;
    container.innerHTML = `
